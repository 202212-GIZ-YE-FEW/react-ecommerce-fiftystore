...
![Alt text](relative%20path/to/img1.png?raw=true "Home page ")
![Alt text](relative%20path/to/img2.png?raw=true "Product  page ")
![Alt text](relative%20path/to/img3.png?raw=true "Cart page ")
 ### Tools used
 1. Next js 
