        ...
        <footer className="bg-gray-100 mt-10 ">
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 container md:p-6 p-4 md:flex md:items-center md:justify-between">
                ...
                <ul className="flex flex-wrap items-center mt-3 text-sm text-stone-700 sm:mt-0">
                    <li>
                        <Link href={`/products/category/${categories[2]}`} className="mr-4 hover:underline md:mr-6">Men&apos;s Clothing</Link>
                    </li>
                    <li>
                        <Link href={`/products/category/${categories[3]}`} className="mr-4 hover:underline md:mr-6">Women&apos;s Clothing</Link>
                    </li>
                    <li>
                        <Link href={`/products/category/${categories[1]}`} className="mr-4 hover:underline md:mr-6">Jewelry</Link>
                    </li>
                    <li>
                        <Link href={`/products/category/${categories[0]}`} className="hover:underline">Electronics</Link>
                    </li>
                </ul>
            </div>
