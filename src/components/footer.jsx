        ...
        <footer class="bg-white">
            ...
            <div class="w-full mx-auto container md:p-6 p-4 md:flex md:items-center md:justify-between">
                ...
                <ul class="flex flex-wrap items-center mt-3 text-sm text-gray-500 dark:text-gray-400 sm:mt-0">
                    <li>
                        <a href="#" class="mr-4 hover:underline md:mr-6 ">Men's Clothing</a>
                    </li>
                    <li>
                        <a href="#" class="mr-4 hover:underline md:mr-6">Women Clothing</a>
                    </li>
                    <li>
                        <a href="#" class="mr-4 hover:underline md:mr-6">Jewelery</a>
                    </li>
                    <li>
            ...
            <div class="w-full mx-auto container md:p-6 p-4 flex items-center justify-center">
